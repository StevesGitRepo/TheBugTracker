            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         Description="Single page html, css & javascript page.  Landing page that contains a bio and links to all applications and challenges." ,
                     ...
                     new Project()
                     {
                         ...
                         Description="Custom built web application using .Net Core with MVC, a postgres database and hosted in a Railway container.  The app is designed for the candidate to create, update and maintain a live blog site.",
